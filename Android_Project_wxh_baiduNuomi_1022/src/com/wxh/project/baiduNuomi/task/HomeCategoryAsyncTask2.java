...
public class HomeCategoryAsyncTask2 extends AsyncTask<String, Void, HomeCategory>{
	private Context context;
	private ImageView imgBanners;
	private GridViewForScrollView gvSpecial;
	
	public static GridViewForScrollView gvCategory;
	public static HomeCategory homeCategory;
	public static CategoryAdapter categoryAdapter;
	public static boolean flagHomeCategoryList = false;

	public HomeCategoryAsyncTask2(Context context, ImageView imgBanners,
...
//		}
	...
	protected void onPostExecute(HomeCategory result) {
		...
		SpecialAdapter specialAdapter = new SpecialAdapter(context, result);
		gvSpecial.setAdapter(specialAdapter);
		
		//设置标志位
		flagHomeCategoryList = true;
